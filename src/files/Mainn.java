...
*importing roster, updating athlete object with roster, and creating a points system based on sports played. 
*/
...
static File getCSVFile(Scanner in, File csv) {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		// File spread = new File("file.csv"); // declaring file. in future versions
		...
		File csv = null;
		Scanner testingfile = null; // scanner for csv file
		...
		System.out.println("Hi, welcome to the Medway Highschool Sportsheet editor. ");
		System.out.println(
				"Please make sure to download the spreadsheet as a csv file and add it to the folder that contains this program.");
		csv = getCSVFile(in, csv);
